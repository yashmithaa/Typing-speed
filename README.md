# Typing-speed-tester
 This application enables you to test your typing speed by taking a typing test, creating a profile, and saving your progress and high scores. The GUI is developed using Tkinter, and the database is managed using .csv files.
